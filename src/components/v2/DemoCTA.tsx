      ...
      <div className="relative z-10 p-6 sm:p-12 md:p-24 rounded-[2.5rem] sm:rounded-[4rem] bg-neutral-950 text-white overflow-hidden border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl text-neutral-400 mb-16 font-medium leading-relaxed max-w-3xl mx-auto"
          >
          ...
          >
            <Button size="lg" className="w-full sm:w-auto h-16 sm:h-20 px-8 sm:px-14 text-lg sm:text-xl font-black group shadow-2xl shadow-primary/40">
              Schedule a Visit
              <ArrowRight className="w-6 h-6 ml-2 transition-transform group-hover:translate-x-1" />
            </Button>
            <Button variant="outline" size="lg" className="w-full sm:w-auto h-16 sm:h-20 px-8 sm:px-14 text-lg sm:text-xl font-black border-white/20 hover:bg-white hover:text-neutral-900 group">
